...
const featuredProjects: Project[] = [
  ...
  {
    id: 2,
    title: "Lotana - Whitestone Beach and Apartment",
    category: "Solar Installation",
    description: "A premium beachfront apartment powered by our custom solar installation, enabling sustainable, reliable energy for both hospitality and residential comfort by the sea.",
