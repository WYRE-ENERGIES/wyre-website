...
const clientPortfolio = [
  ...
  { name: "ATC Nigeria", netWorth: 0 },                 // Not publicly available (private)
];
      ...
      <div className="group relative m-auto max-w-[90rem] max-md:px-6">
        ...
        <div className="flex flex-col items-center md:flex-row">
          <div className="max-md:flex items-center gap-x-1 md:max-w-44 md:border-r md:pr-6">
            <p className="text-end font-semibold text-sm text-muted-foreground">Client Portfolio Networth Over</p>
