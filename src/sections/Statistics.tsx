...
const Statistics = () => {
  ...
  return (
    <section className="relative py-12 flex items-center justify-center lg:py-16">
      <div className="max-2xl:px-6 max-w-[87rem] w-full mx-auto px-6">
        {error && (
        ...
        >
          ...
          >
            ...
            <p className="text-4xl xl:text-5xl font-bold text-heading mb-2">
              <Counter end={30} suffix=" MW" isInView={isStatsInView} />
            </p>
